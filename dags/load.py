...
# from scripdata_reader import DataReader
...
class ELT:
    ...
    def extract_data(self,file_path=None,) -> None:
        ...
        vehicle_df.to_csv(os.path.join(self.save_dag_path,'/home/addisu/Desktop/10 academy/data/vehicle_info.csv'),index=False)
        trajectories_df.to_csv(os.path.join(self.save_dag_path,'/home/addisu/Desktop/10 academy/data/trajectories_info.csv'), index=False)
        
        # Load trajectories data from CSV file and insert into the database
    def load_trajectory_data(self):
        trajectories_df = pd.read_csv(os.path.join(self.save_dag_path, './data/trajectories_info.csv'))
...
elt = ELT('/home/addisu/Desktop/10 academy/data/raw_data.csv',
         "/home/addisu/Desktop/10 academy/data/")